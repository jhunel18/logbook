...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        initComponents();
        lblCurrentTime.setText(LocalDateTime.now().toLocalDate().toString());
    ...
    private void initComponents() {
        ...
        jButton1.setText("View History Logs");
        ...
        lblCurrentTime.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
